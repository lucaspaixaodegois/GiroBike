package br.unitins.girobike.filter;
...
public class SecurityFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (endereco.equals("/GiroBike/faces/login.xhtml")) {
		...
		if (usuario == null) {
			((HttpServletResponse) response).sendRedirect("/GiroBike/faces/login.xhtml");
		}  else {
			...
			((HttpServletResponse) response).sendRedirect("/GiroBike/faces/acessonegado.xhtml");
